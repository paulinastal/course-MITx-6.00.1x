    ...
    def build_shift_dict(self, shift):
        ...
        for letter in lowercase:
            if ord(letter) + shift < 123:
                ...
                shift_dict[letter] = chr(shift + ord(letter) - 26)
    ...
    def apply_shift(self, shift):
        ...
        for letter in self.message_text:
            if letter in self.build_shift_dict(shift):
                shifted_message_text = shifted_message_text + self.build_shift_dict(shift)[letter]
            else:
                shifted_message_text = shifted_message_text + letter
